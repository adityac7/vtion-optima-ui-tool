...
// Create a function to generate the icon components
const createIconComponent = (Icon: typeof BarChart | typeof LineChart | typeof Play | typeof TrendingUp) => {
  return () => <Icon className="h-12 w-12 text-vtion-purple" />;
};
...
export const modules: ModuleData[] = [
  {
    ...
    icon: createIconComponent(BarChart)(),
  ...
  },
  {
    ...
    icon: createIconComponent(TrendingUp)(),
    link: "#", 
